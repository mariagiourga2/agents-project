...
public class CityMap : MonoBehaviour
{
    ...
    void ExportCityToFile()
    {
        ...
        foreach (GameObject building in buildings)
        {
            ...
            string description = $"Building at position (x: {pos.x:F2}, y: {pos.y:F2}, z: {pos.z:F2}) marked as '*'";
            cityDescription.Add(description);
        }
        // Καταγραφή των σημαντικών κτιρίων
        //Φούρνος
        foreach (GameObject B in bakery)
        {
        ...
        //Super Market
        foreach (GameObject M in superMarket)
        {
            
            Vector3 pos = M.transform.localPosition;
            string description = $"Super Market at position (x: {pos.x}, y: {pos.y}, z: {pos.z}) marked as 'M'";
            cityDescription.Add(description);
        }
        //Στάδιο
        foreach (GameObject S in stadium)
        {
        ...
        //Φαρμακείο
        foreach (GameObject D in drugStore)
        {
        ...
        //Βενζινάδικο
        foreach (GameObject G in gasStation)
        {
        ...
        //Εργοστάσιο
        foreach (GameObject f in facrory)
        {
        ...
        //Energy Pots
        foreach (GameObject E in Energy_Pot)
        {
        ...
        {
            Vector3 pos = park.transform.localPosition;
